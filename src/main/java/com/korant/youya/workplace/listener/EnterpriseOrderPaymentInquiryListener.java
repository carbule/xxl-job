 ...
 */
@Slf4j
public class EnterpriseOrderPaymentInquiryListener extends DefaultConsumer {

    public EnterpriseOrderPaymentInquiryListener(Channel channel) {
        super(channel);
    }

    @Override
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        log.info("[EnterpriseOrderPaymentInquiryListener]接收到消息");
