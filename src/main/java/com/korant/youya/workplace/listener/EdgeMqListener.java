...
public class EdgeMqListener {
    ...
    public void jobShareQueue(Channel channel, Message msg) throws IOException {
        log.info("job.share，收到消息");
        String messageBodyString = new String(msg.getBody());
        try {
            SharedDto sharedDto = JSON.parseObject(messageBodyString, SharedDto.class);
    ...
    public void huntJobShareQueue(Channel channel, Message msg) throws IOException {
