...
/**
 * @ClassName HuntJobSubTaskListener
 * @Description
 * @Author chenyiqiang
 ...
 */
@Slf4j
public class HuntJobSubTaskListener extends DefaultConsumer {

    public HuntJobSubTaskListener(Channel channel) {
        super(channel);
    }

    @Override
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        log.info("[HuntJobSubTaskListener]接收到消息");
