...
/**
 * @ClassName HuntJobBonusAllocationListener
 * @Description
 * @Author chenyiqiang
 ...
 */
@Slf4j
public class HuntJobBonusAllocationListener extends DefaultConsumer {

    public HuntJobBonusAllocationListener(Channel channel) {
        super(channel);
    }

    @Override
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        log.info("[HuntJobBonusAllocationListener]接收到消息");
